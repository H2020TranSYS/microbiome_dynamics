...
# setwd("C:/Users/fmelo/Documents/GitHub/microbiome_dynamics/MAGMA_APPROACH/OTUS_node_analysis_difference")
...
rownames(w0_n335_OTU_table) = w0_n335_OTU_table[,1]; w0_n335_OTU_table =w0_n335_OTU_table %>% dplyr::select(-X.OTU.ID)
rownames(w0_n335_OTU_table6M) = w0_n335_OTU_table6M[,1]; w0_n335_OTU_table6M = w0_n335_OTU_table6M %>% dplyr::select(-X.OTU.ID)
rownames(w0_n335_OTU_table9M) = w0_n335_OTU_table9M[,1]; w0_n335_OTU_table9M = w0_n335_OTU_table9M %>% dplyr::select(-X.OTU.ID)
