...
png("Suppl_Graph_Diet_persistent_vs_NONPERS_1sd.png", width = 300, height = 300, units='mm', res = 300)
p
dev.off()
...
png("Suppl_Graph_Diet_persistent_vs_NONPERS_2sd.png", width = 300, height = 300, units='mm', res = 300)
p
dev.off()
...
png("Suppl_Graph_Delivery_1sd.png", width = 300, height = 300, units='mm', res = 300)
p
dev.off()
...
png("Suppl_Graph_Delivery_2sd.png", width = 300, height = 300, units='mm', res = 300)
p
dev.off()
